...
# Paths and constants
save_dir="/mnt/abka03/concept_extraction_result/coco/concept"
...
for concept in "${concepts[@]}"; do
    ...
    saved_features_path="/mnt/abka03/concept_extraction_result/coco/features/save_hidden_states_noun_phrase_qwen2_image_concept_hidden_states_${concept_clean}.pth"
