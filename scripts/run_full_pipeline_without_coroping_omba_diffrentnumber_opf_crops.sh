...
OUTPUT_DIR="${OUTPUT_DIR:-$ROOT_DIR/outputs/qwen2_5_10cls_sam/imnet100}"
...
MIN_IMAGES_PER_TAG="${MIN_IMAGES_PER_TAG:-100}" # This the minimum frequency of objects to be selected for cropping.
MAX_IMAGES_PER_TAG="${MAX_IMAGES_PER_TAG:-600}" #  This the upperlimit of images going to crop for further processing 
BAG_SIZE="${BAG_SIZE:-500}" # max number of crop/image chosen for each concept bag,
