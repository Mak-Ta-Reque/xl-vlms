...
# ========================
SPLIT="train"
BASE_SAVE_DIR="/mnt/abka03/concept_extraction_result/oneclass/gemma3n/MCoX/SNMF/rabbit/${SPLIT}"
FEATURES_PATH="$BASE_SAVE_DIR/features/save_hidden_states_sentence_qwen2_patched_image_oneimage_crops_token_of_interest_concept_generation.pth"
