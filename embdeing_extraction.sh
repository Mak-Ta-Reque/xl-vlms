...
concepts=("a parachute" "dog" "chainsaw" "french horn" "gas station" "cassette player" "charch" "fish" "garbage truck" "golf ball")  # Add more concepts as needed

# Paths
base_data_dir="/mnt/abka03/crops/train"
save_dir="/mnt/abka03/concept_extraction"
